...
public class BorrowerServiceImpl extends ServiceImpl<BorrowerMapper, Borrower> implements BorrowerService {
    ...
    public void saveBorrowerVOByUserId(BorrowerVO borrowerVO, Long userId) {
        ...
        List<BorrowerAttach> borrowerAttachList=new ArrayList<>();
        for (int i = 0; i < 4; i++) {
            ...
            borrowerAttach.setImageName(imageName);
            borrowerAttach.setImageUrl("http://test2015data.oss-cn-hangzhou.aliyuncs.com/image-hroot/year20216/image-202161/report/file_210603092521490364.png?x-oss-process=image/resize,l_400,m_mfit");
            borrowerAttach.setImageType(imageName);
            borrowerAttachList.add(borrowerAttach);
        }
        //保存附件
